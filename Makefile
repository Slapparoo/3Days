CC=clang
CFLAGS=$(shell pkg-config --cflags portaudio-2.0) -Ofast -g3  -m64 -fno-omit-frame-pointer -DUSE_NETWORKING -Wno-implicit-function-declaration -Wno-int-conversion -Wno-incompatible-function-pointer-types
