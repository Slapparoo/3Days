...
./proot -r chroot -w /3Days ./3d_loader --noruntime -c HCRT_TOS.BIN --binheader HCRT/HCRT.HH FULL_RUNTIME.HC
cp chroot/3Days/HCRT_TOS.BIN ./HCRT/HCRT_TOS.BIN
source make.tcsh

echo "Recompiling HCRT/HCRT.BIN for non-chroot's SDL2"
./3d_loader --noruntime -c HCRT/HCRT_TOS.BIN --binheader HCRT/HCRT.HH FULL_RUNTIME.HC
