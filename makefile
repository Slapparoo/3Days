...
3d: $(OBJS) HCRT/HCRT.BIN main.cyborg.o
	gcc $(OBJS) main.cyborg.o -lncurses -ltinfo -lpthread -lreadline -lSDL2 -lm -o $@
...
3d.bootstrap: aot.o tags.o rl.o vec.o rt.o jitlib-core.o map.o compile.o lexer.o HolyC.o unesc.o tosprn.o gc.o debugger.o rope.o main.o at3.o exceptLin.o asm.o
